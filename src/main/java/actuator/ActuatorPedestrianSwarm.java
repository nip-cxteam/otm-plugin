...
public class ActuatorPedestrianSwarm extends AbstractActuator {
    ...
    public ActuatorPedestrianSwarm(Scenario scenario, jaxb.Actuator jaxb_actuator) throws OTMException {
